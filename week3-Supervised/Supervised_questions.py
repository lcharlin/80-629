...
# ### First let's generate a few datasets and plot the training and testing splits. 
# 
...
# **Question 1 (NB)**: The fitting procedure for a Naive Bayes classifier is described below. Fill in the gaps with missing text (double-click on this cell to be able to edit in the text).
#     
